<script setup lang="ts">
    ...
    // Fields.
    const { __typename, background_color, width, has_vertical_padding, has_horizontal_padding, illustration_type, image, icon, title, content } = toRefs(props.data);
...
<template>
    <div :class="[ has_horizontal_padding ? 'px-0 xl:px-12' : '', 'flex justify-center items-center w-full' ]">
