...
<template>
    <div class="w-full max-w-7xl px-6 xl:px-12">
        ...
        <div :class="[ show_title ? 'mt-5' : '', partners.length > 4 ? 'flex flex-wrap' : 'grid grid-cols-4 sm:grid-cols-6 lg:grid-cols-5', 'justify-center items-center gap-x-8 gap-y-12 sm:gap-x-10 sm:gap-y-14 lg:mx-0 lg:max-w-none py-8 3xl:py-12' ]">
