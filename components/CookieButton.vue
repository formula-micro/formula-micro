...
<template>
    <div>
      <!-- Main content -->
      <CookieBanner v-if="showBanner" @close="showBanner = false" />
      
      <!-- Cookie Button -->
      <button 
        @click="showBanner = true" 
        class="fixed bottom-4 right-4 bg-sky-700 text-white py-2 px-4 rounded-lg shadow-lg"
      >
        Vis cookie indstillinger
      </button>
