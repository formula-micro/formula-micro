      ...
      <div class="flex-1 lg:w-2/3 lg:pr-6 mb-4 lg:mb-0">
        ...
        <div class="flex flex-wrap gap-4 lg:gap-6"> 
          ...
          <div class="flex items-center">
            <img src="/images/googleMapsLogo.png" alt="Google Maps Logo" class="w-5 h-5 lg:w-6 lg:h-6 mr-2" />
            <label for="googleMap" class="text-sm lg:text-base text-gray-700 mr-2">Google Map</label>
            <ToggleSwitch pt:input="bg-pinkoi-navy-900" pt:slider="bg-pinkoi-navy-900"
              id="googleMap" 
              v-model="googleMap"  
            />
          </div>
